...
class MilanoPrev extends Component {
  state = {
    weather: {},
    isLoading: true,
    hasError: false,
  ...
  fetchPasiano = async () => {
    try {
      const response = await fetch(
        "https://api.openweathermap.org/data/2.5/weather?lat=45.4654219&lon=9.1859243&appid=0b06337c917c360bf8b12646bc3deb78&units=metric"
      );
      ...
      >
        <Row className="d-flex align-items-center">
          ...
          <Col xs={12} md={6} className="text-end p-0">
            <Image
              src="https://www.italia.it/content/dam/tdh/en/interests/lombardia/milano/milano-in-48-ore/media/20220119115535-piazza-del-duomo-all-alba-milano-lombardia-shutterstock-1161075943-rid.jpg"
